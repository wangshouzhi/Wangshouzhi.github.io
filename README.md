...
# SNS settings
github_username: wangshouzhi     # 你的github账号
...
1. 这个模板是从这里 [Hux](https://github.com/wangshouzhi/Wangshouzhi.github.io) fork 的, 感谢这个作者。
2. 感谢 Jekyll、Github Pages 和 Bootstrap!

## License

遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/wangshouzhi/wangshouzhi.github.io/blob/master/LICENSE)。
